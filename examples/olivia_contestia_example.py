...
from pydigi import Olivia4_125, Olivia8_250, Olivia8_500, Olivia16_500, Olivia16_1000, Olivia32_1000
from pydigi import (
    Contestia4_125,
    Contestia4_250,
    Contestia8_125,
...
def main():
    ...
    print(
        f"   Generated: olivia_16_500_no_tones.wav ({len(audio)} samples, {len(audio)/8000:.2f}s)"
    )
